...
public class ModFluids {
    ...
    public static final FluidRegistryObject UU_MATTER = registerFluid("uu_matter", 0xFFFF00FF, 1000, 1000,      
            () -> new MobEffectInstance(MobEffects.REGENERATION, 100, 1), false, null, 0, false);

    public static final FluidRegistryObject CONSTRUCTION_FOAM = registerFluid("construction_foam", 0xFF888888, 2000, 1000,
            () -> new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 100, 1), false, null, 0, false);
    ...
    public static final FluidRegistryObject PAHOEHOE_LAVA = registerFluid("pahoehoe_lava", 0xFFFF4400, 3000, 3000,
            null, true, () -> Blocks.BASALT, 100, false);

    public static final FluidRegistryObject BIOMASS = registerFluid("biomass", 0xFF228822, 1000, 1000,
            null, false, null, 0, false);

    public static final FluidRegistryObject BIOGAS = registerFluid("biogas", 0xFFEEDD88, 500, 100,
            null, false, null, 0, true);

    public static final FluidRegistryObject AIR = registerFluid("air", 0xFFFFFFFF, 100, 10,
            null, false, null, 0, true);

    public static final FluidRegistryObject HYDROGEN = registerFluid("hydrogen", 0xFFDDFFFF, 100, 10,
            null, false, null, 0, true);

    public static final FluidRegistryObject OXYGEN = registerFluid("oxygen", 0xFF88FFFF, 100, 10,
            null, false, null, 0, true);

    public static final FluidRegistryObject STEAM = registerFluid("steam", 0xFFDDDDDD, 100, 10,
            null, false, null, 0, true);

    public static final FluidRegistryObject SUPERHEATED_STEAM = registerFluid("superheated_steam", 0xFFFFFF88, 100, 10,
            null, false, null, 0, true);

    public static final FluidRegistryObject PESTICIDE = registerFluid("pesticide", 0xFF888800, 1000, 1000,
            () -> new MobEffectInstance(MobEffects.CONFUSION, 200, 0), false, null, 0, false);
    ...
    public static final FluidRegistryObject HOT_WATER = registerFluid("hot_water", 0xFF88FFFF, 1000, 1000,      
            () -> new MobEffectInstance(MobEffects.REGENERATION, 100, 1), false, () -> Blocks.WATER, 100, false);      
