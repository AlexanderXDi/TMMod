...
public class ElectricHeatGeneratorMenu extends AbstractContainerMenu {
    ...
    public ItemStack quickMoveStack(Player player, int index) {
        ...
        if (slot != null && slot.hasItem()) {
            ...
            int invSize = 13;
            if (index < invSize) {
                if (!this.moveItemStackTo(itemstack1, invSize, invSize + 36, true)) return ItemStack.EMPTY;
            } else {
                if (itemstack1.is(mopk.tmmod.registration.ModItems.COIL.get())) {
                    if (!this.moveItemStackTo(itemstack1, 1, 11, false)) return ItemStack.EMPTY;
                    ...
                    if (!this.moveItemStackTo(itemstack1, invSize, invSize + 27, false)) return ItemStack.EMPTY;
                }
            }
